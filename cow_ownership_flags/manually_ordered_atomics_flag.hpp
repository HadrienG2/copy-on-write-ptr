...
namespace cow_ownership_flags {
   ...
   // This implementation of the copy-on-write ownership flag uses manually ordered atomics to
   ...
   class manually_ordered_atomics_flag {
      public:
         ...
         manually_ordered_atomics_flag(bool initially_owned) :
         ...
         manually_ordered_atomics_flag(manually_ordered_atomics_flag && other) :
